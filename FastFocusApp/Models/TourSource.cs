	...
	public class TourSource {
		...
		static TourSource() {
			...
			_tourStops.Add(new TourStop
			{
				...
				ImageUri = "~/Images/Tours/Stops/Pastry.jpg" ,
				Selected = true,
				EstimatedMinutes = 30,
			...
			_tourStops.Add(new TourStop
			{
				...
				ImageUri = "~/Images/Tours/Stops/Fountain.jpg",
				Selected = true,
				EstimatedMinutes = 15,
			});
			...
			_tourStops.Add(new TourStop
			{
				...
				,
				ImageUri = "~/Images/Tours/Stops/ArtInstitute.jpg",
				Selected = false,
			...
			_tourStops.Add(new TourStop
			{
				...
				ImageUri = "~/Images/Tours/Stops/Cloud.jpg",
				Selected = true,
				EstimatedMinutes = 15
			});
			...
			_tourStops.Add(new TourStop
			{
				...
				ImageUri = "~/Images/Tours/Stops/Garden.jpg",
				Selected = false,
				EstimatedMinutes = 20,
			});
			...
			_tourStops.Add(new TourStop
			{
				...
				ImageUri = "~/Images/Tours/Stops/Pretzel.jpg",
				Selected = true,
				EstimatedMinutes = 15,
			});
